@extends('layouts.app') @section('title', 'Admin: Barang Masuk Dari RMA') @section('content')
    <div class="container full-width">
        ...
        @if ($shipments->isEmpty())
            <p class="no-data">Tidak ada barang masuk dari RMA yang menunggu diterima.</p>
        @else
                    ...
                    <tbody>
                        @foreach ($shipments as $shipment)
                            <tr>
                                ...
                                <td class="actions">
                                    <a href="{{ route('shipments.rma.inbound_from_admin.show', $shipment->id) }}" class="view-button">Lihat Detail</a>

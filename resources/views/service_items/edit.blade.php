...
<body>
    <h1>Edit Barang Servis: {{ $serviceItem->item_name }}</h1>
    ...
    <form action="{{ route('service_items.update', $serviceItem->id) }}" method="POST">
        ...
        <div class="form-group">
            ...
            <textarea name="analisa_kerusakan" id="analisa_kerusakan">{{ old('analisa_kerusakan', $serviceItem->analisa_kerusakan) }}</textarea>
